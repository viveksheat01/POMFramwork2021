...
public class Constants {
	...
	public static final List<String> EXP_ACCOUNTS_SECTIONS_LIST = new ArrayList<String>(
			Arrays.asList("My Account", "My Orders", "My Affiliate Account", "Newsletter"));

	public static final int IMAC_IMAGE_COUNT = 3;
	public static final String RESITER_SUCESS_MESSAGE = "Your Account Has Been Created!";
	public static final String REGITER_SHEET_NAME = "register";
